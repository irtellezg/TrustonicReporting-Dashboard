...
import type { StatusSummary, RegionSummary, SolutionSummary } from '../services/api';
            ...
            <div className="card-body chart-container" style={{ minHeight: '420px' }}>
                <ResponsiveContainer width="100%" height={400}>
                    ...
                    >
                        ...
                        <Bar dataKey="completed" name="Completados" fill="#10b981" stackId="a" barSize={24} />
                        <Bar dataKey="testing" name="En Pruebas" fill="#3b82f6" stackId="a" barSize={24} />
                        <Bar dataKey="issues" name="Con Problemas" fill="#f59e0b" stackId="a" barSize={24} />
                        <Bar dataKey="cancelled" name="Cancelados" fill="#ef4444" stackId="a" barSize={24} radius={[0, 4, 4, 0]}>
                            {/* @ts-ignore */}
